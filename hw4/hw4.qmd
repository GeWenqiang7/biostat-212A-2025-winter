...
```{r}
# Create a sample dataset similar to the figure
set.seed(42)
data <- data.frame(
  X1 = runif(100, 0, 1),  # X1 predictor between 0 and 1
  X2 = runif(100, 0, 1),  # X2 predictor between 0 and 1
  Y = sample(c(15, 0, 5, 3, 10), 100, replace = TRUE) # Target variable based on regions
)
